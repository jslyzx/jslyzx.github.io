...
<body>
  ...
  <object type="application/x-shockwave-flash" style="outline:none;" data="pendulumClockV2.swf" width="300" height="200"><param name="movie" value="pendulumClockV2.swf"></param><param name="AllowScriptAccess" value="always"></param><param name="wmode" value="opaque"></param><param name="bgcolor" value=""/></object>
